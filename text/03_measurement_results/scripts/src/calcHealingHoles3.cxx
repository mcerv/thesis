...
int32_t main (void) {
  ...
  int32_t nFilesIndividual[nTemp] = {1,1, 1, 1, 1, 1,1};
  int32_t numSkip[nTemp] = { 1, 1, 1, 1,1,1, 1};

  string tempS[nTemp] = { "1", "10", "11", "12", "13", "14", "15"};

  double delay[nTemp] = {-1, 1, 5, 15, 30, 60, 900 };

  string tempName[nTemp] = {"Avg",
                            "The worst 0",
                            "Better",
                            "Better",
                            "Better",
  ...
  ofstream fout ("data/healing3.txt");
