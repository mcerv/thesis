...
int32_t main (void) {
  ...
  int32_t nFilesIndividual[nTemp] = { 1, 1, 1, 1};
  int32_t numSkip[nTemp] = { 1, 1, 1, 1};

  string tempS[nTemp] = { "1", "10", "16", "17"};

  double delay[nTemp] = {-1, 1, 300, 600}; //seconds. -1 because it's a clean pulse
  ...
  ofstream fout ("data/healing4.txt");
