...
// ------------------------------ MAIN PROGRAM ----------------------
int32_t main (void) {
  cout<<"Calculating HEALING 2 ... ELECS"<<endl;
  ...
  int32_t nFilesIndividual[nTemp] = { 1, 1, 1, 1,1};
  int32_t numSkip[nTemp] = { 1, 1, 1, 1,1};

  string tempS[nTemp] = { "1", "9", "16", "17", "18"};

  double delay[nTemp] = {-1, 1, 30, 180, 600}; //seconds. -1 because it's a clean pulse
  ...
  ofstream fout ("data/healing2.txt");
