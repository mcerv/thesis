...
int32_t main (void) {
  ...
  // h1->SetLineWidth(1);
  h1->Draw();
  TLegend *leg1 = new TLegend(0.65,0.77,0.95,0.95,NULL,"brNDC");
  leg1->AddEntry(h1,"#gamma energy","");
  leg1->Draw("same");
  can1->Update();
  can1->WaitPrimitive();
  can1->Update();
  ...
  h3->Draw();
  h3->Rebin(2);
  TLegend *leg3 = new TLegend(0.65,0.77,0.95,0.95,NULL,"brNDC");
  leg3->AddEntry(h3,"#beta energy","");
  leg3->Draw("same");
  can3->Update();
  can3->WaitPrimitive();
  can3->Update();
  ...
  // h2->SetLineWidth(1);
  h2->Draw();
  TLegend *leg2 = new TLegend(0.65,0.77,0.95,0.95,NULL,"brNDC");
  leg2->AddEntry(h2,"#alpha energy","");
  leg2->Draw("same");
  can2->Update();
  can2->WaitPrimitive();
  can2->Update();
