{
    ...
    TH1F *h1 = new TH1F("h1","Collected charge for AM241 source",80,0,0.8);
    TH1F *h2 = new TH1F("h2","Collected charge for AM241 source",80,0,0.8);
    TH1F *h3 = new TH1F("h3","Collected charge for AM241 source",80,0,0.8);
    
    
    //   Connect file generated in $ROOTSYS/test
    TFile f1("../results/S37/AM241_Cx/S37_AM241_Cx_500V.root");
    TFile f2("../results/S50/AM241_Cx/S50_AM241_Cx_500V.root");
    TFile f3("../results/1scdhq/AM241_Cx/1scdhq_AM241_Cx_500V.root");
    ...
    h1->GetXaxis()->SetTitle("Pulse amplitude @ 500V [V]");
    ...
    leg->AddEntry(h1,"S37","L");
    leg->AddEntry(h2,"S50","L");
    leg->AddEntry(h3,"1scdhq","L");
    leg->Draw();
