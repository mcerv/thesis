...
%\centering
\begin{tabular}{cccc}
\subfloat[Cx charge sensing preamplifier]{\includegraphics[width=0.45\textwidth]{03_measurement_results/pics/setup/Cx} \label{fig:ampcx}} &
\subfloat[C2 fast charge preamplifier]{\includegraphics[width=0.45\textwidth]{03_measurement_results/pics/setup/C2}  \label{fig:ampc2}}
\end{tabular}
...
%\centering
\begin{tabular}{cccc}
\subfloat[PCB carrier with an embedded diamond sample]{\includegraphics[width=0.45\textwidth]{03_measurement_results/pics/setup/carrier2} \label{fig:carrier}} &
\subfloat[Radioactive source over the carrier]{\includegraphics[width=0.45\textwidth]{03_measurement_results/pics/setup/carriersource2}  \label{fig:carsrc}}
\end{tabular}
...
\centering
\begin{tabular}{rrr}
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/samplePulses/alpha} \label{fig:alpha1}} &
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/samplePulses/alphadist} \label{fig:alphadist1}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/samplePulses/beta}  \label{fig:beta1}} &
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/samplePulses/betadist}  \label{fig:betadist1}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/samplePulses/gamma}  \label{fig:gamma1}} &
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/samplePulses/gammadist}  \label{fig:gammadist1}} 
\end{tabular}
...
\centering
\begin{tabular}{rrr}
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/plotLifetime/holes0} \label{fig:holes0lt}} &
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/plotLifetime/elecs0} \label{fig:elecs0lt}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/plotLifetime/holes15}  \label{fig:holes15lt}} &
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/plotLifetime/elecs15}  \label{fig:elecs15lt}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/plotLifetime/holes30}  \label{fig:holes30lt}} &
\subfloat{\includegraphics[width=0.45\textwidth]{03_measurement_results/scripts/plots/plotLifetime/elecs30}  \label{fig:elecs30lt}}
\end{tabular}
