...
\subfloat{\includegraphics[width=0.80\textwidth]{scripts/plots/radfactor1}  \label{fig:radfactor}}
\end{tabular}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.8\textwidth]{scripts/plots/amplvstimecx4}
