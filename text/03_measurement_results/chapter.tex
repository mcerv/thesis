...
The first observation of the raw acquired data in figures~\ref{fig:lifetimeelecsholes} is that the initially stable pulses start deteriorating; several different shapes start appearing gradually, some still very similar to those from the beginning while the others with almost zero amplitude. 
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.70\textwidth]{03_measurement_results/scripts/plots/taunew/lifetimevstemp}
