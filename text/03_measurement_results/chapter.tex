...
\begin{figure}[!t]
\begin{tabular}{cccc}
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/charge500V} \label{fig:chgtempelecs}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/charge-500V}  \label{fig:chgtempholes}}
\end{tabular}
