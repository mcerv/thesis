...
\centering
\begin{tabular}{rrr}
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/samplePulses/alpha} \label{fig:alpha1}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/samplePulses/alphadist} \label{fig:alphadist1}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/samplePulses/beta}  \label{fig:beta1}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/samplePulses/betadist}  \label{fig:betadist1}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/samplePulses/gamma}  \label{fig:gamma1}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/samplePulses/gammadist}  \label{fig:gammadist1}} 
\end{tabular}
...
\centering
\begin{tabular}{cccc}
\subfloat{\includegraphics[width=0.80\textwidth]{scripts/plots/ccd} \label{fig:ccd}} \\
\subfloat{\includegraphics[width=0.80\textwidth]{scripts/plots/radfactor}  \label{fig:radfactor}}
\end{tabular}
\caption{First figure shows the CCD for S37, S79 and S52 at a range of bias voltage settings. The charge collection distance at 500~V bias voltage for the three diamond samples is then compared to the RD42 data for pion irradiation in the second figure. The data points are about 5--15~\% lower than expected from the RD42 data~\cite{RD42IRRAD:00000}.}
\end{figure}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.8\textwidth]{plots/ccdpriming}
\caption{Relative increase of charge collection over time due to priming with the $^{90}$Sr radioactive source. The bias voltage for this measurement is 1~V/$\upmu$m.}
...
\centering
\begin{tabular}{rrr}
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/plotLifetime/holes0} \label{fig:holes0lt}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/plotLifetime/elecs0} \label{fig:elecs0lt}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/plotLifetime/holes15}  \label{fig:holes15lt}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/plotLifetime/elecs15}  \label{fig:elecs15lt}} \\
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/plotLifetime/holes30}  \label{fig:holes30lt}} &
\subfloat{\includegraphics[width=0.45\textwidth]{scripts/plots/plotLifetime/elecs30}  \label{fig:elecs30lt}}
\end{tabular}
...
It turns out that the methods (3) and (5) improve the shape, method (2) helps slowly, (1) does not show any change with time and (4) at first improves, but then significantly degrades the shape. The effect observed in method (4) has already been described in~\cite{Kramberger:2013wva}. The ``healing'' process therefore depends on the rate of radiation, the bias voltage and the time of exposure. The ionising radiation creates free charges, which quickly recombine close to the place of generation. It is likely that they also release the charges trapped during the measurement, reducing the overall effect of the space charge. The traps get filled with both flavours of carriers, thus they are neutralised. The pulse shape gradually returns to its initial state.
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.8\textwidth]{scripts/plots/plotLifetime/formCorrelation}
\caption{Five procedures for the ``healing'' process for an irradiated diamond that was exposed to $\upalpha$ radiation at bias voltage switched on for at least 30~minutes at a rate of $10^4$~s$^{-1}$.}
\label{fig:formCorr}
\end{center}
\end{figure}
