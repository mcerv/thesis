...
%\centering
\begin{tabular}{cccc}
\subfloat[Cx charge sensing preamplifier.]{\includegraphics[width=0.47\textwidth]{03_measurement_results/pics/setup/Cx} \label{fig:ampcx}} &
...
\end{enumerate}
The results in this and in the following section show that, in both cases, priming plays an important role in improving the diamond measurement stability. 
