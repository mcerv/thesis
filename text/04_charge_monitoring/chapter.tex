...
The telescopes were installed onto the pixel detector structure that had been extracted from ATLAS due to pixel detector commissioning. The installed DBM is shown in figure~\ref{fig:dbminatlas}.
