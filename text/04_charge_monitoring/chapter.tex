...
\subfloat[A pixel efficiency distribution from the run in figure (a).]{\includegraphics[width=0.45\textwidth]{../scripts/04_charge_monitoring/plots/distribution}  \label{fig:beamdist}}
\end{tabular}
...
\centering
\begin{tabular}{cccc}
\subfloat{\includegraphics[width=0.48\textwidth]{../scripts/04_charge_monitoring/plots/D0-add} \label{fig:raddist}} &
\subfloat{\includegraphics[width=0.46\textwidth]{../scripts/04_charge_monitoring/plots/Z0}  \label{fig:longdist}}
\end{tabular}
