...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\textwidth]{../scripts/04_charge_monitoring/plots/pseudoefficiency} 
...
\centering
\begin{tabular}{cccc}
\subfloat{\includegraphics[width=0.7\textwidth]{../scripts/04_charge_monitoring/plots/D0} \label{fig:raddist}} \\
\subfloat{\includegraphics[width=0.7\textwidth]{../scripts/04_charge_monitoring/plots/Z0}  \label{fig:longdist}}
\end{tabular}
