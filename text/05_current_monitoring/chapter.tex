...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/pulse/alpha2params}
...
\begin{figure}[!t]
\begin{tabular}{rr}
\subfloat{\includegraphics[width=0.43\textwidth]{05_current_monitoring/plots/logic1} \label{fig:logic1}} &
\subfloat{\includegraphics[width=0.43\textwidth]{05_current_monitoring/plots/logic2}  \label{fig:logic2}}
\end{tabular}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.45\textwidth]{05_current_monitoring/plots/algobase}
...
Figure~\ref{fig:co1} shows the triangular pulses created by the incident $\upgamma$ particles. The distribution is very similar to that created by the incident electrons in figure~\ref{fig:sr1}. This is expected; MeV-range $\upgamma$ particles interact via Compton scattering, freeing an electron which in turn ionises the sensor. Therefore the resulting current pulses of an incident $\upgamma$ are similar to those of an incident $\upbeta$.
...
\begin{figure}[]
\centering
\includegraphics[width=0.54\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/10-area-0-1}
...
\begin{figure}[]
\centering
\includegraphics[width=0.99\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/10-scatter-10-add}
...
\begin{figure}[]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/18-area-0-1}
...
\begin{figure}[]
\centering
\includegraphics[width=0.99\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/13-scatter-11}
...
\begin{figure}[]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/13-area-0-11}
...
\begin{figure}[]
\centering
\includegraphics[width=0.99\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/12-scatter-11}
...
The one-dimensional histogram in figure~\ref{fig:1dcoarea} shows the area distribution with the maximum at $\sim$60~pVs, which is in agreement with the background $\upgamma$ radiation emitted by the $^{241}Am$~source, as shown in figure~\ref{fig:1dalphaareae}. This is again not a Landau distribution, but instead only its tail. Relative to the 600~pVs $\upalpha$ peak, the expected MPV of MeV-range $\upgamma$ energy distribution is $\sim$30~pVs, which is not the case in the acquired spectrum (peaking at 60~pVs). This is due to a self-trigger (amplitude threshold), which does not trigger on low current pulses and thus cuts the left part of the distribution. The low pulses cannot be measured due to the high electronics noise of the amplifier and consequently a high trigger threshold to avoid noise triggers. 
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/12-area-0-11} 
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/spaceChargeStudy}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/triga-08-area-0-1}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/15-area-4-1}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/reportATI/15-area-11-1}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{../../../CIVIDEC/dataRead/data/plots/epfl-area-1}
...
Then several radioactive sources were used to calibrate the device. 
