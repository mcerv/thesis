...
\end{tabular}
\caption{Left: a simplified equivalent circuit of a current amplifier. Right: an input and an output signal of the current amplifier. The black line represents the output at C$_mathrm{d}=0$ whereas the red, blue and purple line show the response for increasing C$_mathrm{d}$.}
\end{figure}
