...
\begin{figure}[!t]
\begin{tabular}{cccc}
\subfloat[Valence bonds in the crystalline structure can be broken, creating a free electron-hole pair]{\includegraphics[width=0.22\textwidth]{plots/semilattice9} \label{fig:semilattice9}} &
\subfloat&
