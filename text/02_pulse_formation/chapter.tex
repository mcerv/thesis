...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\textwidth]{01_introduction/pics/ibl}
...
%\centering
\begin{tabular}{cccc}
\subfloat{\includegraphics[width=0.47\textwidth]{02_pulse_formation/pics/proton-stopping-power} \label{fig:psp}} &
\subfloat{\includegraphics[width=0.47\textwidth]{02_pulse_formation/pics/electron-stopping-power}  \label{fig:esp}}
\end{tabular}
\caption{Stopping power in diamond for protons (left) and electrons (right). Courtesy CIVIDEC.}
\end{figure}
...
%\begin{figure}[!t]
%\begin{center}
%\includegraphics[width=0.6\linewidth]{../scripts/02_pulse_formation/plots/resolution}
...
\subfloat{\includegraphics[width=0.47\textwidth]{../scripts/02_pulse_formation/plots/CurrentAmp}  \label{fig:currc}}
\end{tabular}
\caption{Left: a simplified equivalent circuit of a current amplifier. Right: input and output signal of the current amplifier. The red line represents the input and the output at C$_\mathrm{d}=0$. Blue lines show the signal response for increasing C$_\mathrm{d}$ (decreasing bandwidth from dark blue to light blue).}
\end{figure}
...
%(0.5 pg)
In order to measure integrated charge in the sensor, a feedback loop is added to the amplifier, as shown in figure~\ref{fig:chgamp}. The feedback can be used to control the gain and input resistance, as well as to integrate the input signal. The charge amplifier is in principle an inverting voltage amplifier with a low input impedance. 
...
\subfloat{\includegraphics[width=0.47\textwidth]{../scripts/02_pulse_formation/plots/ChargeAmp}  \label{fig:chgrc}}
\end{tabular}
\caption{Left: a simplified equivalent circuit of a charge amplifier. Right: input and output signal of the charge amplifier. The red line represents the input signal. Blue lines show a bandwidth-limited signal response at a range of RC-constants (dark blue for high RC and light blue for low RC).}
\end{figure}
