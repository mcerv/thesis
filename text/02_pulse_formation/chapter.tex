...
\subfloat&
\subfloat[The freed electron-hole pair starts drifting in the externally applied electric field. The electron and hole drift in the opposite directions towards the oppositely charged electrods]{\includegraphics[width=0.33\textwidth]{02_pulse_formation/pics/plots/simpledrift} \label{fig:simpledrift}} &
\subfloat[Equivalent electrical circuit. The moving charges act as a current source]{\includegraphics[width=0.33\textwidth]{02_pulse_formation/pics/plots/simpledrifteq}  \label{fig:simpledrifteq}}
\end{tabular}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.6\linewidth]{02_pulse_formation/pics/plots/raddamage}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.45\linewidth]{02_pulse_formation/pics/plots/currrc}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.45\linewidth]{02_pulse_formation/pics/plots/chgrc}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=0.55\linewidth]{02_pulse_formation/pics/plots/qerr}
...
%\centering
\begin{tabular}{cccc}
\subfloat[Xilinx Virtex 5 FPGA~\cite{FPGA:00000}]{\includegraphics[width=0.45\textwidth]{02_pulse_formation/pics/fpga} \label{fig:fpga}} & 
\subfloat[ASIC~\cite{ASIC:00000}]{\includegraphics[width=0.45\textwidth]{02_pulse_formation/pics/asic}  \label{fig:asic}}
\end{tabular}
