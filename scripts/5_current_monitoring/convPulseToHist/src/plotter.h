...
public:
  ...
  void fillWaveformC2( int32_t, uint8_t*);
  void analyseWaveform( int32_t, uint8_t*);
  void showHistFwhm();
  void showHist_v4();
  void showWaveform();
  void setMonitorValues(int32_t, int32_t, int32_t, float, float, double, int32_t, int32_t);
  ...
  void saveMaxAmplitudeHistogram(uint32_t histmaxampl[]);

  /// histogramming Cx Ampl
  void initHistAmpl();
  void showHistAmpl();
  void fillHistAmpl( int32_t, uint8_t*);
